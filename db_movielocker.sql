...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 28, 2023 at 02:56 AM
...
--
-- Table structure for table `tbl_lockermovies`
--

CREATE TABLE `tbl_lockermovies` (
...
--
-- Indexes for table `tbl_lockermovies`
--
ALTER TABLE `tbl_lockermovies`
  ADD UNIQUE KEY `locker-movie-id` (`locker_id`,`movie_id`);
